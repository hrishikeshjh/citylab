...
export function PatientDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col font-sans text-foreground">
      {/* ── Top Header ── */}
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50 px-6 py-3.5 flex items-center justify-between shadow-sm">
        {/* Logo */}
        ...
        <div className="hidden md:flex items-center relative w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-xs rounded-full border border-gray-200 bg-gray-50 focus:outline-none focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/10 transition-all"
          />
        </div>
        ...
        <div className="flex items-center gap-4">
          {/* Notifications */}
          <button className="p-2 rounded-full hover:bg-gray-50 relative text-gray-600 transition-colors">
            <Bell className="h-5 w-5" />
            <span className="absolute top-1.5 right-1.5 h-2.5 w-2.5 bg-primary border-2 border-white rounded-full" />
          </button>
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2 pl-1.5 pr-3 py-1 rounded-full border border-gray-200 bg-white hover:border-primary/30 hover:shadow-sm transition-all"
            >
              {user?.photoURL ? (
                <img
                  src={user.photoURL}
            ...
            {profileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-4 py-2 text-xs text-gray-700 hover:bg-gray-50 border-t border-gray-50 transition-colors text-left font-medium"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-4 py-2.5 text-xs text-red-600 hover:bg-red-50 border-t border-gray-50 transition-colors text-left font-semibold"
                >
      ...
      <div className="flex-1 flex">
        {/* ── Sidebar Navigation ── */}
        <aside className="w-64 bg-white border-r border-gray-100 hidden lg:block p-4">
        ...
        <main className="flex-1 p-6 md:p-8 max-w-5xl mx-auto overflow-y-auto">
          ...
          {activeTab === "dashboard" && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-4">
                      ...
                      <div>
                        <h3 className="text-sm font-bold text-gray-900">Dr. Ananya Sharma</h3>
                        <p className="text-[10px] text-gray-500">General Physician</p>
                      </div>
                    </div>
                  </div>

                  <div className="border-t border-b border-gray-50 py-3.5 my-4 flex items-center justify-between text-xs">
                    <div>
                      <p className="font-bold text-gray-800">12 July</p>
                      <p className="text-[10px] text-gray-500">10:30 AM</p>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-gray-50 text-[11px] font-bold text-gray-700 hover:bg-gray-100 transition-colors"
                  >
                    View Details
                  </button>
                </div>
                ...
                <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
                  <div>
                    <h3 className="text-base font-bold text-gray-900">Home Collection</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                {/* Recent Reports */}
                <div className="md:col-span-8 bg-white border border-gray-100 rounded-3xl p-6 shadow-sm">
                  ...
                  <div className="space-y-3">
                    {/* CBC */}
                    <div className="flex items-center justify-between p-3.5 rounded-2xl bg-gray-50/50 hover:bg-gray-50 transition-colors">
                      <div>
                        <p className="text-xs font-bold text-gray-900">CBC Report</p>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1 text-[10px] font-bold text-gray-600 border border-gray-200 bg-white rounded-lg hover:bg-gray-50 transition-colors"
                        >
                          View Online
                        </button>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3.5 rounded-2xl bg-gray-50/50 hover:bg-gray-50 transition-colors">
                      <div>
                        <p className="text-xs font-bold text-gray-900">Vitamin D Report</p>
                        <p className="text-[10px] text-green-600 font-medium">Completed</p>
                      </div>
                      <button
                    ...
                    {/* Thyroid Profile */}
                    <div className="flex items-center justify-between p-3.5 rounded-2xl bg-gray-50/50">
                      <div>
                        <p className="text-xs font-bold text-gray-900">Thyroid Profile</p>
                ...
                {/* Active Bookings */}
                <div className="md:col-span-4 bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
                  <div>
                    <h3 className="text-sm font-bold text-gray-900 mb-4 flex items-center gap-2">
                    ...
                    <div className="p-4 rounded-2xl bg-orange-50/30 border border-orange-100/50">
                      <p className="text-xs font-bold text-gray-900">Complete Blood Count</p>
                      <div className="mt-3 space-y-1.5 text-[10px] text-gray-500 font-medium">
                        <p>Date: Tomorrow</p>
                        <p>Time: 09:30 AM</p>
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-2 rounded-xl border border-gray-100 text-[11px] font-bold text-gray-600 hover:bg-gray-50 transition-colors"
                  >
                    Manage Bookings
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={idx} className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
                      ...
                      <p className="text-lg font-bold text-gray-800 mt-1">{stat.val}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  {[
                    ...
                    >
                      <div>
                        <h4 className="text-xs font-bold text-gray-900">{pkg.name}</h4>
                        <p className="text-[10px] text-gray-500 mt-1.5">{pkg.desc}</p>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    ...
                    <div
                      ...
                      className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:border-primary/20 transition-all cursor-pointer flex flex-col justify-between"
                    >
                      <div>
                        <span className="text-[9px] font-bold text-primary bg-primary/5 px-2 py-0.5 rounded">
                          {art.read}
                        </span>
                        <h4 className="text-xs font-bold text-gray-900 mt-2 hover:text-primary transition-colors">
                          {art.title}
                        </h4>
                        <p className="text-[10px] text-gray-500 mt-1.5">{art.desc}</p>
                      </div>
          ...
          {activeTab !== "dashboard" && (
            <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm text-center min-h-[400px] flex flex-col items-center justify-center animate-fadeIn">
